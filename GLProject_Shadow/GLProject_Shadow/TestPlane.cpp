...
TestPlane::TestPlane() : Object()
{
	...
	m_meshModel.SetConnectivity();
	m_meshModel.SetPlaneEq(TestPlaneData::vertices);
...
void TestPlane::RenderShadow(float lightPos[4])
{
	PaintShadow(TestPlaneData::vertices, lightPos);
}
