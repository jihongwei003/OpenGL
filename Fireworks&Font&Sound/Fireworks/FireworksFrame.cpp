...
void FireworksFrame::Init()
{
	...
	//声音系统的创建
	soundSys.CreatSys(1);
	soundSys.LoadSound("Happy New Year.mp3");

	soundSys.PlayMusic("Happy New Year.mp3"); //背景音乐在这里播放！
...
void FireworksFrame::Display()
{
	...
	//soundSys.SetSrcAttributes("Idina Menzel-Let It Go.mp3", srcPos, srcVel);

	/*FMOD_VECTOR earPos;
	FMOD_VECTOR earVel;
	FMOD_VECTOR earForward;
	FMOD_VECTOR earUp;
	...
	soundSys.SetEarAttributes(earPos, earVel, earForward, earUp);*/

	//soundSys.Update3DEffect();
